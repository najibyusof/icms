                    ...
                    <form action="{{ route('programmes.update', $programme) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Brief description of the programme">{{ old('description', $programme->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('accreditation_body') is-invalid @enderror" 
                                   id="accreditation_body" name="accreditation_body" value="{{ old('accreditation_body', $programme->accreditation_body) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('duration_semesters') is-invalid @enderror" 
                                   id="duration_semesters" name="duration_semesters" value="{{ old('duration_semesters', $programme->duration_semesters) }}" 
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                            <a href="{{ route('programmes.show', $programme) }}" class="btn btn-outline-secondary">Cancel</a>
